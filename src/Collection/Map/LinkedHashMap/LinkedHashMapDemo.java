...
public class LinkedHashMapDemo {
    public static void main(String[] args) {
        ...
        linkedHashMap.put(20,"Grapes"); // it maintains the order on the based of (insertion) not like a sorted hash map which based on natural order of keys
...
// The iteration order will now be: 1 -> 3 -> 2, because 2 was accessed last LEAST RECENT USE
